package com.junit.caozhiou.sideproject.view.cloudview;
...
public class CloudView extends LinearLayout {
    ...
    private void uiInitView() {
        ...
        int w = MeasureSpec.makeMeasureSpec(0,
                MeasureSpec.UNSPECIFIED);//屏幕view宽
        int h = MeasureSpec.makeMeasureSpec(0,
                MeasureSpec.UNSPECIFIED);//屏幕viewh
        ...
        //动态设置云图片大小
        LayoutParams linearParams = (LayoutParams) mRlCloudImageBag.getLayoutParams();
