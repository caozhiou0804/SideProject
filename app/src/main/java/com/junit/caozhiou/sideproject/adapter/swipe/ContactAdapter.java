...
package com.junit.caozhiou.sideproject.adapter.swipe;
...
import com.junit.caozhiou.sideproject.adapter.swipe.expandRecyclerviewadapter.StickyRecyclerHeadersAdapter;
import com.junit.caozhiou.sideproject.entity.ContactModel;
import com.junit.caozhiou.sideproject.fragment.PinnedHeaderRecyclerViewFragment;
...
//    private Context mContext;
    ...
    public ContactAdapter(Fragment fragment, List<ContactModel.MembersEntity> mLists, int permission, String createrID) {
        this.mLists = mLists;
//        mContext = ct;
        ...
        if (getItem(position).getId().equals(OWNER)) {
            ...
            holder.mDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((PinnedHeaderRecyclerViewFragment) fragment).deleteUser(position);
                }
            });
        } else {
